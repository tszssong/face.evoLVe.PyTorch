...
class Layer_param():
    ...
    def upsample_param(self,size=None, scale_factor=None):
        ...
        if scale_factor:
            upsample_param.scale = int(scale_factor)
        #     if isinstance(scale_factor,int):
        #         upsample_param.scale = scale_factor
        #     else:
        #         upsample_param.scale_h = int(scale_factor)
        #         upsample_param.scale_w = int(scale_factor)
        #
        # if size:
        #     if isinstance(size,int):
        #         upsample_param.upsample_h = size
        #     else:
        #         upsample_param.upsample_h = int(size[0] * scale_factor)
        #         upsample_param.upsample_w = int(size[1] * scale_factor)
