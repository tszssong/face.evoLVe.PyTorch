...
configurations = {
    1: dict(
        ...
        DATA_ROOT = '/data03/zhengmeisong/data/ms1m_emore_img/',
        ...
        BACKBONE_NAME = 'IR_18', # support: ['IR_18','ResNet_50', 'ResNet_101', 'ResNet_152', 'IR_50', 'IR_101', 'IR_152', 'IR_SE_50', 'IR_SE_101', 'IR_SE_152']
        ...
        GPU_ID = [2,3], # specify your GPU ids
        PIN_MEMORY = True,
        NUM_WORKERS = 0,
    ),
}
