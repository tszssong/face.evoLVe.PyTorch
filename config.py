...
configurations = {
    1: dict(
        ...
        DATA_ROOT = '/data01/zhengmeisong/data/ms1m-retina-1w/', # the parent root where your train/val/test data are stored
        ...
        LOSS_NAME = 'Focal',   # support: ['Focal', 'Softmax', 'Triplet']
