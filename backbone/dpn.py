...
def dpn92(input_size =[224, 224], emb_size =2, pretrained=False, test_time_pool=False, **kwargs):
...
def dpn107(input_size =[224, 224], emb_size =2,pretrained=False, test_time_pool=False, **kwargs):
    ...
    model = DPN(
        ...
        test_time_pool=test_time_pool,num_classes=emb_size, **kwargs)
    if pretrained:
...
class DPN(nn.Module):
    def __init__(self, small=False, num_init_features=64, k_r=96, groups=32,
        ...
        self.classifier3 = nn.Conv2d(in_chs, num_classes, kernel_size=1, bias=True)
