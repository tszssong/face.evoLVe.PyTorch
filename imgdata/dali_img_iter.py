...
class reader_pipeline(Pipeline):
    def __init__(self, image_dir, batch_size, num_threads, device_id):
        ...
        self.augmentations = {}
        self.augmentations["contrast"] = dali_ops.Contrast(device = "gpu", contrast = 0.125)
        self.augmentations["brightness"] = dali_ops.Brightness(device = "gpu", brightness = 0.125)
        self.augmentations["saturation"] = dali_ops.Saturation(device = "gpu", saturation = 0.125)
